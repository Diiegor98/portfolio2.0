        ...
        <div className="lg:p-8 flex flex-col gap-4">
          <div className="grid grid-cols-1 gap-4 md:grid-cols-3 ">
            <div className="gap-2 h-full rounded-lg border border-t-8 border-t-blue-500 flex flex-col justify-between items-center p-3 cursor-pointer hover:scale-105 duration-500">
              ...
              <span>
                Algoritmos, estructuras de datos y lógica condicional. Utilizar
            ...
            <div className="gap-2 h-full rounded-lg border border-t-8 border-t-blue-500 flex flex-col justify-between items-center p-3 cursor-pointer hover:scale-105 duration-500">
              ...
              <span>
                ...
                Responsive design y Frameworks como Bootstrap y Tailwind.
              </span>
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-4">
            <div className="gap-2 h-full rounded-lg border border-t-8 border-t-blue-500 flex flex-col justify-between items-center p-3 cursor-pointer hover:scale-105 duration-500">
              ...
              <span>
                Uso de herramientas de desarrollo como Webpack, Babel y ESlint.
                npm para dependencias y paquetes.
              </span>
            ...
            <div className="gap-2 h-full md:col-span-2 rounded-lg border border-t-8 border-t-blue-500 flex flex-col justify-between items-center p-3 cursor-pointer hover:scale-105 duration-500">
              ...
              <span>
                Conceptos básicos como variables, datos, operadores, funciones.
                Me adentré en el DOM y cómo manipularlo para actualizar su
                contenido. También investigué sobre conceptos avanzados como
                promesas, async/await y manipulación de eventos.
              </span>
              <div className="border border-blue-400 rounded-full p-2 grayscale hover:grayscale-0">
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-4">
            <div className="gap-2 h-full md:col-span-2 rounded-lg border border-t-8 border-t-blue-500 flex flex-col justify-between items-center p-3 cursor-pointer hover:scale-105 duration-500">
              ...
              <span>
                SPA y creación de interfaces de usuarios. Utilizar componentes,
                hooks y el manejo del estado. Librerias como React Router y
                React Hook Form. Esta etapa fué una de las más enriquecedoras ya
                que me proporcionó habilidades para crear webs complejas y
                escalables.
              </span>
              <div className="border border-blue-400 rounded-full p-2 grayscale hover:grayscale-0">
